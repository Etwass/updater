...
typedef size_t (*NET_FN_WRITE_CALLBACK)(void *, size_t, size_t, void *);
...
int net_get_listing(NET_HANDLE, const CONNECTION_CONFIG *, NET_FN_WRITE_CALLBACK, void *);
int net_download(NET_HANDLE, const CONNECTION_CONFIG *, NET_FN_PROGRESS, NET_FN_WRITE_CALLBACK, void *);
